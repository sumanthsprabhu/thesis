...
int read_y4() {
  ...
  /* __CPROVER_assume((!is_local || loc == yloc) && */
  /* 		   (is_local || (yloc <= loc && loc < MAXYW))); */

  __CPROVER_assume((!is_local || (yloc <= loc && loc <= (MAXYW/2))) && 
		    (is_local || (yloc <= loc && loc < MAXYW)));
...
int read_x4() {
  ...
  /* __CPROVER_assume((!is_local || loc == xloc) && */
  /* 		   (is_local || (xloc <= loc && loc < MAXXW))); */

  __CPROVER_assume((!is_local || xloc <= loc && loc <= (MAXXW/2)) &&
  		   (is_local || (xloc <= loc && loc < MAXXW)));
