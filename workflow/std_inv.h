...
readv1_inv()
{unsigned char lr1;
  /* underapproximation constrain  start */
  _Bool is_local;
  cpa((!is_local || lr1 == lrv1)
      && (is_local || lr1 >=  lrv1  && lr1 < v1qsize)  );
   /* underapproximation constrain end */
 cpa(v1t[lr1+1] > v2t[lrv2]);
lrv1  = lr1;
}
writev1 ()
...
{unsigned char lr1;
    /* underapproximation constrain  start */
  _Bool is_local;
    cpa((!is_local || lr1 == lrv2)
	&& (is_local || lr1 >=  lrv2  && lr1 < v2qsize)  );
    /* underapproximation constrain end */
 cpa(v2t[lr1+1] > v1t[lrv1]);
lrv2  = lr1;
}
